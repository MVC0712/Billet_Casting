...
$(document).on("click", "#summary_table tbody tr", function (e) {
  ...
  activateStep(checkActivateStep());
  Total();
  changeElement();
});
...
function activateStep(step) {
  switch(step) {
    case "step_1":
      $(".step_1 input.save-data").each(function (index, element) {
        $(this).removeClass("complete-input").addClass("no-input").attr("disabled", false);
      });
      $(".step_1 select.save-data").each(function (index, element) {
        $(this).removeClass("complete-input").addClass("no-input").attr("disabled", false);
      });
      $("#product_dim").val(1).removeClass("no-input").addClass("complete-input")
      $(".step_2 input.save-data").each(function (index, element) {
        $(this).removeClass("no-input").addClass("complete-input").attr("disabled", true);
      });
    ...
    case "step_2":
      ...
      $(".step_2 input.no-need").each(function (index, element) {
        $(this).removeClass("no-input").addClass("complete-input").attr("disabled", false);
      });
      $(".step_3 input.save-data").each(function (index, element) {
        $(this).removeClass("no-input").addClass("complete-input").attr("disabled", true);
      });
